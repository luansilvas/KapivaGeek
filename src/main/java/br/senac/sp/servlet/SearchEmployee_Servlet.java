 ...
 * @author luans
 */
public class SearchEmployee_Servlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        System.out.println("OLHA O QUE EU PEGUIE" +acao);
        ...
        switch (acao) {
            ...
            case "Previous":
                ...
                lista = EmployeeDAO.getEmployeePaginatedBySeach(currentPage - 20, 10, pesquisa);
            ...
            case "First":
                ...
                break;
            case "Next":
                lista = EmployeeDAO.getEmployeePaginatedBySeach(currentPage, 10, pesquisa);
                currentPage = currentPage + 10;
                break;
            case "Last":
