<%-- 
    Document   : atualizarSenhaUsuario
    Created on : 27/04/2021, 18:13:01
    Author     : luans
--%>
...
<html>
    ...
    <body>
        ...
        <section id="main" class="containerMain">
            ...
            <form class="formCadastro" method="post" action="<c:url value="/updateCustomerPassword_Servlet"/>" novalidate class="form">
                <fieldset>

                    <legend>Atualizar senhas</legend>
