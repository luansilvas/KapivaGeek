<%-- 
    Document   : ativaInativaEndereco
    Created on : 27/04/2021, 19:39:40
    Author     : luans
--%>
...
<html>
    ...
    <body>
        ...
        <section id="main" class="containerMain">
            ...
            <form class="formCadastro" method="post" novalidate class="form">
                <fieldset>
                    <legend>Confirmar inativação</legend>

                    <div class="divsForm">
                        <label>Titulo</label>
                        <br>
                        <input type="text" name="titulo" value="${address.address_code}"readonly>
                    </div>
                    <div class="divsForm">
                        <label>CEP</label>
                        <br>
                        <input type="text" name="cep" placeholder="CEP" id="cep" value="${address.address_code}" readonly>
                        <br>
                    </div>
                    <div class="divsForm" id="senha">
                        ...
                        <input type="text" placeholder="Número" name="number" id="numero" value="${address.address_number}" readonly>
                    </div>

                    <div class="divsForm">
                        <label>Complemento</label>
                        <br>
                        <input type="text" name="complement" id="complemento" value="${address.address_complement}" readonly>
                    </div>
                    <div class="divsForm">
                        <label>Bairro</label>
                        <br>
...
<input type="text" name="customerId" value="${address.customer_customer_id}" readonly style="display:none">
                    ...
                    <a href="<c:url value="/InativateAddress_Servlet?address_id=${address.address_id}&acao=inativa"/>" class="btn btn-primary btn-lg active" role="button" aria-pressed="true">Inativar</a>
                    </div> 
